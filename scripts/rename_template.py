...
It renames all the occurrences of locomotion_dev (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the locomotion_dev folder
        os.rename(
            os.path.join(root_dir_path, "exts", "locomotion_dev", "locomotion_dev"),
            os.path.join(root_dir_path, "exts", "locomotion_dev", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "locomotion_dev"), os.path.join(root_dir_path, "exts", new_name))
