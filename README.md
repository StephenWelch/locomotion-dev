...
- Throughout the repository, the name `locomotion_dev` only serves as an example and we provide a script to rename all the references to it automatically:

```
# Rename all occurrences of locomotion_dev (in files/directories) to your_fancy_extension_name
